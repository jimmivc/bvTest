...
func TestFindSongByArtist(t *testing.T)  {
	...
	statusAndResponseGetTest(mux,"/api/songs/artist/",`not found`,t)
...
func TestFindSongByName(t *testing.T)  {
	...
	statusAndResponseGetTest(mux,"/api/songs/",`not found`,t)
}
...
func TestFindSongByGenre(t *testing.T)  {
	...
	statusAndResponseGetTest(mux,"/api/songs/genre/",`not found`,t)
}
